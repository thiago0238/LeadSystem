...
export async function GET() {
  try {
    ...
    //       description:
    //         "Aprenda HTML, CSS e JavaScript para criar sites modernos e responsivos.",
    //     },
    //     {
    //       name: "React.js",
    //       description:
    //         "Desenvolvimento de aplicações modernas com React, Redux e React Hooks.",
    //     },
    //     {
    //       name: "Node.js",
    //       description: "Backend JavaScript com Node.js, Express e MongoDB.",
    //     },
    //     {
    //       name: "Python para Iniciantes",
    //       description:
    //         "Introdução à programação com Python, desde o básico até conceitos avançados.",
    //     },
    //     {
    //       name: "Data Science",
    //       description:
    //         "Análise de dados e machine learning com Python, Pandas e Scikit-learn.",
    //     },
    //     {
    //       name: "UX/UI Design",
    //       description:
    ...
    //       description:
    //         "Metodologias ágeis e tradicionais para gerenciamento de projetos.",
    //     },
    //   ];
    ...
    //       message: "Nenhum curso encontrado para criar leads",
    //     });
    //   }
    ...
    return NextResponse.json(
      { error: "Falha ao executar seed", details: error },
      { status: 500 }
    );
  }
}
